    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSingUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!fullname.equals("") && !username.equals("") && !password.equals("") && !email.equals("") && !phone.equals("")) {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            data[3] = email;
                            data[4] = phone;
                            PutData putData = new PutData("http://theoneproduction.atwebpages.com/LoginRegister/signup.php", "POST", field, data);
                            if (putData.startPut()) {
