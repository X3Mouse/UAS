...
public class Dashboard extends AppCompatActivity {
    ...
    String HTTP_JSON_URL = "http://theoneproduction.atwebpages.com/ImageJSONdata.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManagerOfrecyclerView = new LinearLayoutManager(Dashboard.this);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            GestureDetector gestureDetector = new GestureDetector(Dashboard.this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                ...
                if(view != null && gestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    Toast.makeText(Dashboard.this, ImageTitleNameArrayListForClick.get(RecyclerViewItemPosition), Toast.LENGTH_LONG).show();
                }
    ...
    public void ParseJSonResponse(JSONArray array){
        ...
        recyclerViewadapter = new RecyclerViewAdapter(ListOfdataAdapter, Dashboard.this);
