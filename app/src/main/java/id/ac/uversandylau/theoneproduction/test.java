...
public class test extends AppCompatActivity {
    ...
    public void Submitorder(View view) {
        ...
        CheckBox whippedcreamChekBo= (CheckBox) findViewById(R.id.WhippedCream_checkbo);
        boolean haswhippedcrea=whippedcreamChekBo.isChecked();//mengidentifikasi check
        Log.v("MainActivity","has whippedcream:"+haswhippedcrea);
        ...
        CheckBox chocolateChekBox= (CheckBox) findViewById(R.id.WhippedCream_checkbox);
